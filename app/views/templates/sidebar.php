...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="#" class="brand-link text-center">
    <span class="brand-text font-bold">PUSTAKA MI Pelalawan</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="<?= base_url; ?>/buku" class="nav-link" aria-label="Buku">
        ...
        <li class="nav-item">
          <a href="<?= base_url; ?>/kategori" class="nav-link" aria-label="Kategori">
